...
class HybridConnectivityManagementAPI:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: azure.mgmt.hybridconnectivity.aio.operations.Operations
    :ivar endpoints: EndpointsOperations operations
    :vartype endpoints: azure.mgmt.hybridconnectivity.aio.operations.EndpointsOperations
