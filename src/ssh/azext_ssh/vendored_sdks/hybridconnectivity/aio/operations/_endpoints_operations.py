...
class EndpointsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.hybridconnectivity.aio.HybridConnectivityManagementAPI`'s
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :param endpoint_name: The endpoint name. Required.
        :type endpoint_name: str
        :param endpoint_resource: Endpoint details. Is either a model type or a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(endpoint_resource, (IO, bytes)):
    ...
    async def list_credentials(
        ...
        **kwargs: Any
        ...
        :param expiresin: The is how long the endpoint access token is valid (in seconds). Default
         value is 10800.
        :type expiresin: int
        :param list_credentials_request: Object of type ListCredentialsRequest. Is either a model type
        ...
        _json = None
        _content = None
        if isinstance(list_credentials_request, (IO, bytes)):
    ...
    async def list_ingress_gateway_credentials(
        self, resource_uri: str, endpoint_name: str, expiresin: int = 10800, **kwargs: Any
    ...
    async def list_managed_proxy_details(
        ...
        **kwargs: Any
        ...
        :param endpoint_name: The endpoint name. Required.
        :type endpoint_name: str
        :param managed_proxy_request: Object of type ManagedProxyRequest. Is either a model type or a
         IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(managed_proxy_request, (IO, bytes)):
