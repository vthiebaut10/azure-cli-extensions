...
class HybridConnectivityManagementAPI:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = HybridConnectivityManagementAPIConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
    ...
    def __enter__(self) -> "HybridConnectivityManagementAPI":
